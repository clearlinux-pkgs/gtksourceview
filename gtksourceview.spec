...
Source0  : https://download.gnome.org/sources/gtksourceview/3.24/gtksourceview-3.24.2.tar.xz
...
%prep
%setup -q -n gtksourceview-3.24.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1495461829
export AR=gcc-ar
