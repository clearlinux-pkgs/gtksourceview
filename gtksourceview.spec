...
Source0  : https://download.gnome.org/sources/gtksourceview/4.6/gtksourceview-4.6.0.tar.xz
...
%prep
%setup -q -n gtksourceview-4.6.0
cd %{_builddir}/gtksourceview-4.6.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585773150
...
cp %{_builddir}/gtksourceview-4.6.0/COPYING %{buildroot}/usr/share/package-licenses/gtksourceview/caeb68c46fa36651acf592771d09de7937926bb3
