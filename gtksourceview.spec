...
Source0  : https://download.gnome.org/sources/gtksourceview/5.4/gtksourceview-5.4.0.tar.xz
...
%prep
%setup -q -n gtksourceview-5.4.0
cd %{_builddir}/gtksourceview-5.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648056909
...
cp %{_builddir}/gtksourceview-5.4.0/COPYING %{buildroot}/usr/share/package-licenses/gtksourceview/caeb68c46fa36651acf592771d09de7937926bb3
cp %{_builddir}/gtksourceview-5.4.0/data/icons/COPYING %{buildroot}/usr/share/package-licenses/gtksourceview/261167ba61e9acca17c128a339a1ad1f2d6278f1
cp %{_builddir}/gtksourceview-5.4.0/data/snippets/licenses.snippets %{buildroot}/usr/share/package-licenses/gtksourceview/9a2d608368016f836294eefc8e698a08e393f51f
