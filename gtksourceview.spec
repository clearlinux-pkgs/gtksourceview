...
Source0  : https://download.gnome.org/sources/gtksourceview/5.14/gtksourceview-5.14.2.tar.xz
...
%prep
%setup -q -n gtksourceview-5.14.2
cd %{_builddir}/gtksourceview-5.14.2
pushd ..
cp -a gtksourceview-5.14.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732288784
...
/usr/share/gtksourceview-5/language-specs/groff.lang
