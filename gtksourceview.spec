...
%prep
%setup -q -n gtksourceview-4.8.3
cd %{_builddir}/gtksourceview-4.8.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647896277
...
cp %{_builddir}/gtksourceview-4.8.3/COPYING %{buildroot}/usr/share/package-licenses/gtksourceview/caeb68c46fa36651acf592771d09de7937926bb3
