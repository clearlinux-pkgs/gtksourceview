...
Source0  : https://download.gnome.org/sources/gtksourceview/5.12/gtksourceview-5.12.0.tar.xz
...
%prep
%setup -q -n gtksourceview-5.12.0
cd %{_builddir}/gtksourceview-5.12.0
pushd ..
cp -a gtksourceview-5.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710606884
