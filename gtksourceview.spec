...
Source0  : https://download.gnome.org/sources/gtksourceview/3.24/gtksourceview-3.24.4.tar.xz
...
%prep
%setup -q -n gtksourceview-3.24.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1504718687
export AR=gcc-ar
