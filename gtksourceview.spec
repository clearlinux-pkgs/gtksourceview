...
Source0  : https://download.gnome.org/sources/gtksourceview/5.14/gtksourceview-5.14.1.tar.xz
...
%prep
%setup -q -n gtksourceview-5.14.1
cd %{_builddir}/gtksourceview-5.14.1
pushd ..
cp -a gtksourceview-5.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728422413
