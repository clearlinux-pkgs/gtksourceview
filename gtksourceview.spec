...
%prep
%setup -q -n gtksourceview-4.8.2
cd %{_builddir}/gtksourceview-4.8.2
%patch1 -p1
...
cp %{_builddir}/gtksourceview-4.8.2/COPYING %{buildroot}/usr/share/package-licenses/gtksourceview/caeb68c46fa36651acf592771d09de7937926bb3
