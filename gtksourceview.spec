...
Source0  : https://download.gnome.org/sources/gtksourceview/5.6/gtksourceview-5.6.0.tar.xz
...
%prep
%setup -q -n gtksourceview-5.6.0
cd %{_builddir}/gtksourceview-5.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663596326
